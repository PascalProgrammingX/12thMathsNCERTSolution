...
import kotlinx.android.synthetic.main.activity_previous_paper.*
import java.io.File
import java.util.*


class PreviousPaperActivity : AppCompatActivity(), (OthersModel) -> Unit {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Setup recyclerView
        val othersAdapter = OthersAdapter(OthersDataSource.previousPaperPdfUrls, this)
