...
import kotlinx.android.synthetic.main.activity_practice_paper.*
import java.io.File
import java.util.*


class PracticePaperActivity : AppCompatActivity(), (OthersModel) -> Unit {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Setup recyclerView
        val othersAdapter = OthersAdapter(OthersDataSource.praticePaperPdfUrls, this)
